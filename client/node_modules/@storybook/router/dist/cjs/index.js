...
const parsePath$2 = memoizerific(1000)(path => {
  const result = {
    viewMode: undefined,
    storyId: undefined,
    refId: undefined
...
const queryFromString = memoizerific(1000)(s => lib.parse(s, {
...
const getMatch = memoizerific(1000)((current, target, startsWith = true) => {
