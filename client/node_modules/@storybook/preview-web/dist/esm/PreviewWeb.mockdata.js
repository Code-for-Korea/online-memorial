...
export var waitForRender = function waitForRender() {
  return waitForEvents([Events.STORY_RENDERED, Events.DOCS_RENDERED, Events.STORY_THREW_EXCEPTION, Events.STORY_ERRORED, Events.STORY_MISSING]);
};
export var waitForRenderPhase = function waitForRenderPhase(phase) {
  return waitForEvents([Events.STORY_RENDER_PHASE_CHANGED], function (_ref2) {
