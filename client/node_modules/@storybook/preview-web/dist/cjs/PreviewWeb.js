...
var PreviewWeb = /*#__PURE__*/function (_Preview) {
  ...
  function PreviewWeb() {
    ...
    _this.view = new _WebView.WebView();
    _this.urlStore = new _UrlStore.UrlStore(); // Add deprecated APIs for back-compat
    // @ts-ignore

    _this.storyStore.getSelection = (0, _utilDeprecate.default)(function () {
  ...
  _createClass(PreviewWeb, [{
    ...
    value: function setupListeners() {
      ...
      this.channel.on(_coreEvents.default.PRELOAD_STORIES, this.onPreloadStories.bind(this));
    }
  }, {
    ...
    value: function initializeWithStoryIndex(storyIndex) {
      ...
      return _get(_getPrototypeOf(PreviewWeb.prototype), "initializeWithStoryIndex", this).call(this, storyIndex).then(function () {
        ...
        if (!((_global$FEATURES = _global.default.FEATURES) !== null && _global$FEATURES !== void 0 && _global$FEATURES.storyStoreV7)) {
          _this3.channel.emit(_coreEvents.default.SET_STORIES, _this3.storyStore.getSetStoriesPayload());
        }
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                if (storySpecifier === '*') {
                  this.renderStoryLoadingException(storySpecifier, new Error((0, _tsDedent.default)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n            Couldn't find any stories in your Storybook.\n            - Please check your stories field of your main.js config.\n            - Also check the browser console and terminal for error messages.\n          "])))));
                } else {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.t1 = _coreEvents.default.SET_STORIES;
                _context4.next = 7;
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 14:
                storyRender = new _StoryRender.StoryRender(this.channel, this.storyStore, function () {
              ...
              case 22:
                ...
                if (!(_context8.t0 !== _StoryRender.PREPARE_ABORTED)) {
                  _context8.next = 28;
                  break;
                }
              ...
              case 39:
                ...
                if (selection.viewMode === 'docs' || parameters.docsOnly) {
                  this.currentRender = _DocsRender.DocsRender.fromStoryRender(storyRender);
